 ...
 *
 * MODIFIED BY SERIES EIGHT FOR IUBENDA CRAFT PLUGIN
 * - Added 'stateless' option allowing ignoring cookie and user agent status
 * - Use `about:blank` instead of `//cdn.iubenda.com/cookie_solution/empty.html`
 * 	 for suppressed iframes to avoid unnecessary requests
 */
...
class iubendaParser {
	...
	public function __construct( $content_page = '', $args = array() ) {
		...
		// is stateless
		$this->stateless = (bool) ( isset( $args['stateless'] ) && $args['stateless'] === true );
